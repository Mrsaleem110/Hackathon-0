...
# -*- coding: utf-8 -*-
"""
LinkedIn Post - Fully Automated
Posts to Agentic Sphere company page via admin URL
Usage: python linkedin_post.py "Your message here"
"""
import sys
import time
import io
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if 'login' in page.url.lower():
                ...
                print("="*60)
                print("Waiting 20 minutes for you to login...")
